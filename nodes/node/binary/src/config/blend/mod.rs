    ...
    pub fn into_blend_settings(
        ...
        > {
            common: CommonSettings {
                ...
                recovery_path_prefix: self.user.recovery_path_prefix,
                time: TimingSettings {
                    ...
                    // We use the same duration for rounds and for slots.
                    ...
                    // Rounds per session set to slots per epoch.
                    rounds_per_session: slots_per_epoch,
