...
pub fn da_verifier_share_requests() {
    nomos_tracing::metric_counter_u64!(da_verifier_share_requests_total, 1);
}

pub fn da_verifier_share_failed() {
    nomos_tracing::metric_counter_u64!(da_verifier_share_failed_total, 1);
}
...
pub fn da_verifier_tx_requests() {
    nomos_tracing::metric_counter_u64!(da_verifier_tx_requests_total, 1);
}

pub fn da_verifier_tx_failed() {
    nomos_tracing::metric_counter_u64!(da_verifier_tx_failed_total, 1);
}
...
pub fn da_verifier_prune_runs() {
    nomos_tracing::metric_counter_u64!(da_verifier_prune_runs_total, 1);
}

pub fn da_verifier_prune_failed() {
    nomos_tracing::metric_counter_u64!(da_verifier_prune_failed_total, 1);
}
