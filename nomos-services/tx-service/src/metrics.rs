pub fn mempool_transactions_added() {
    nomos_tracing::increase_counter_u64!(mempool_transactions_added_total, 1);
}

pub fn mempool_transactions_removed(removed_count: usize) {
    nomos_tracing::increase_counter_u64!(mempool_transactions_removed_total, removed_count as u64);
}
